...
Route::post('paiements/import', [PaiementController::class, 'import'])->name('paiements.import');
...
Route::get('/admin/compteure', [AdminController::class, 'compteure_index'])->name('admin.compteure_index');
Route::get('/admin/dashboard/stats', [AdminController::class, 'getStats'])->name('admin.dashboard.stats');
Route::get('/admin/dashboard', [AdminController::class, 'dashboard'])->name('admin.dashboard');
Route::get('/admin/users', [controleruser::class, 'users_index'])->name('admin.users');
